      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-300">
            AI-Powered OSINT System for India
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="text-xs text-gray-400 space-y-1">
              <p><strong>Admin:</strong> admin@indosint.com / admin123</p>
              <p><strong>Analyst:</strong> analyst@indosint.com / analyst123</p>
              <p><strong>Investigator:</strong> investigator@indosint.com / investigator123</p>
            </div>
          </div>
        </form>
      </div>
